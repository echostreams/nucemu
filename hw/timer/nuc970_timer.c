...
enum NPCM7xxTimerRegisters {
    ...
    NPCM7XX_TIMER_TCSR1 = 0x4,
    NPCM7XX_TIMER_TICR1,
    NPCM7XX_TIMER_TDR1,

    NPCM7XX_TIMER_TCSR2 = 0x8,
    NPCM7XX_TIMER_TICR2,
    NPCM7XX_TIMER_TDR2,

    NPCM7XX_TIMER_TCSR3 = 0xc,
    NPCM7XX_TIMER_TICR3,
    NPCM7XX_TIMER_TDR3,

    NPCM7XX_TIMER_TCSR4 = 0x0040 / sizeof(uint32_t),
    NPCM7XX_TIMER_TICR4 = 0x0044 / sizeof(uint32_t),
    NPCM7XX_TIMER_TDR4 = 0x0048 / sizeof(uint32_t),

    NPCM7XX_TIMER_TISR = 0x0060 / sizeof(uint32_t),
    //NPCM7XX_TIMER_WTCR,
...
static void npcm7xx_timer_class_init(ObjectClass* klass, void* data)
{
    ...
    dc->desc = "NUC970 Timer Controller";

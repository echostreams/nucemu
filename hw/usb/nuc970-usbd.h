 ...
 * @version  V1.00
 * $Revision: 3 $
 * $Date: 15/05/19 10:19a $
 * @brief    NUC970 USBD driver header file
 *
 * @note
...
extern "C"
{
    ...
    */
    ...
    /** @addtogroup NUC970_USBD_Driver USBD Driver
      @{
    */

    /** @addtogroup NUC970_USBD_EXPORTED_CONSTANTS USBD Exported Constants
      @{
    */
    /// @cond HIDDEN_SYMBOLS
...
/*@}*/ /* end of group NUC970_USBD_EXPORTED_CONSTANTS */

/** @addtogroup NUC970_USBD_EXPORTED_STRUCT USBD Exported Struct
  @{
*/
 ...
 */
    ...
    /*@}*/ /* end of group NUC970_USBD_EXPORTED_STRUCT */
...
/** @addtogroup NUC970_USBD_EXPORTED_MACROS USBD Exported Macros
  @{
*/
...
/*@}*/ /* end of group NUC970_USBD_EXPORTED_MACROS */

/** @addtogroup NUC970_USBD_EXPORTED_FUNCTIONS USBD Exported Functions
  @{
*/
/**
  ...
  */
    ...
    /*@}*/ /* end of group NUC970_USBD_EXPORTED_FUNCTIONS */

    /*@}*/ /* end of group NUC970_USBD_Driver */

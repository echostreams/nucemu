 ...
 * $Revision: 30 $
 * $Date: 15/06/12 2:51p $
 * @brief    NUC970 peripheral access layer header file.
 ...
 *****************************************************************************/
 /**
    ...
    * <b>Introduction</b>
    *
    * This user manual describes the usage of NUC970 family device driver
    *
    * <b>Disclaimer</b>
    *
...
/*@}*/ /* end of group NUC970_PERIPHERAL_MEM_MAP */

/******************************************************************************/
/*                Device Specific Peripheral registers structures             */
/******************************************************************************/
/** @addtogroup NUC970_Peripherals NUC970 Control Register
  NUC970 Device Specific Peripheral registers structures
  @{
*/
...
#define     REG_TMR0_TCSR   (TMR0_BA+0x00)  /*!< Timer Control and Status Register 0  */
#define     REG_TMR0_TICR   (TMR0_BA+0x04)  /*!< Timer Compare Register 0             */
#define     REG_TMR0_TDR    (TMR0_BA+0x08)  /*!< Timer Data Register 0                */

#define     REG_TMR1_TCSR   (TMR1_BA+0x00)  /*!< Timer Control and Status Register 1  */
#define     REG_TMR1_TICR   (TMR1_BA+0x04)  /*!< Timer Compare Register 1             */
#define     REG_TMR1_TDR    (TMR1_BA+0x08)  /*!< Timer Data Register 1                */

#define     REG_TMR2_TCSR   (TMR2_BA+0x00)  /*!< Timer Control and Status Register 2  */
#define     REG_TMR2_TICR   (TMR2_BA+0x04)  /*!< Timer Compare Register 2             */
#define     REG_TMR2_TDR    (TMR2_BA+0x08)  /*!< Timer Data Register 2                */

#define     REG_TMR3_TCSR   (TMR3_BA+0x00)  /*!< Timer Control and Status Register 3  */
#define     REG_TMR3_TICR   (TMR3_BA+0x04)  /*!< Timer Compare Register 3             */
#define     REG_TMR3_TDR    (TMR3_BA+0x08)  /*!< Timer Data Register 3                */

#define     REG_TMR4_TCSR   (TMR4_BA+0x00)  /*!< Timer Control and Status Register 4  */
#define     REG_TMR4_TICR   (TMR4_BA+0x04)  /*!< Timer Compare Register 4             */
#define     REG_TMR4_TDR    (TMR4_BA+0x08)  /*!< Timer Data Register 4                */

#define     REG_TMR_TISR    (TMR0_BA+0x60)  /*!< Timer Interrupt Status Register      */
...
#define     REG_WDT_ATLCTL      (WDT_BA+0x04)  /*!< WDT Alternative Control Register  */
...
/*@}*/ /* end of group NUC970_Peripherals */


/** @addtogroup NUC970_IO_ROUTINE NUC970 I/O Routines
  The Declaration of NUC970 I/O Routines
  @{
 */
...
#define inp8(port)            (*((volatile unsigned char *)(port)))
                              ...
                              /*@}*/ /* end of group NUC970_IO_ROUTINE */

                              /******************************************************************************/
                              /*                Legacy Constants                                            */
                              /******************************************************************************/
                              /** @addtogroup NUC970_legacy_Constants NUC970 Legacy Constants
                                NUC970 Legacy Constants
                                @{
                              */
...
/*@}*/ /* end of group NUC970_legacy_Constants */